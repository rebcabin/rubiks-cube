...
class Algorithm(object):
    ...
    def getPlaneColorSearchSQLOpposite(self,
                                       color):  # accepts a color, then searches its negative, eg, yellow would give rise to {0}="!yellow"
    ...
    def getAnswerForf2lSecondLineTransformation(self, level, box):
        ...
        rule5 = "isInitial=1"
        SQL = "SELECT ruleID from boxPosition where {} and {} and {} and {} and {}".format(
